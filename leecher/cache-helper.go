...
func SaveCache(filename string, cache *entities.PiecesCache) error {
...
func LoadCache(filename string) (*entities.PiecesCache, error) {
	...
	if os.IsNotExist(err) {
		...
		encoder := json.NewEncoder(file)
		encoder.Encode(&entities.PiecesCache{Pieces: map[int]bool{}})
		return &entities.PiecesCache{Pieces: map[int]bool{}}, nil
	}
	...
	var cache entities.PiecesCache
